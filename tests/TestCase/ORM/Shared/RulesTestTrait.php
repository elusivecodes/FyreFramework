...
trait RulesTestTrait
{
    ...
    public function testExistsInCallback(): void
    {
        ...
        $rules->add(RuleSet::existsIn(
            ['user_id'],
            'Users',
            callback: static fn(SelectQuery $q): SelectQuery => $q->where(['id !=' => 1])
        ));
    ...
    public function testExistsInNull(): void
    {
        ...
        $rules->add(RuleSet::existsIn(['user_id'], 'Users', allowNullableNulls: false));
    ...
    public function testExistsInTargetFields(): void
    {
        ...
        $rules->add(RuleSet::existsIn(['title'], 'Users', targetFields: ['name']));
    ...
    public function testIsClean(): void
    {
        ...
        $rules->add(RuleSet::isClean(['name']));
    ...
    public function testIsUnique(): void
    {
        ...
        $rules->add(RuleSet::isUnique(['name']));
    ...
    public function testIsUniqueCallback(): void
    {
        ...
        $rules->add(RuleSet::isUnique(
            ['name'],
            callback: static fn(SelectQuery $q): SelectQuery => $q->where(['name !=' => 'Test'])
        ));
    ...
    public function testIsUniqueNull(): void
    {
        ...
        $rules->add(RuleSet::isUnique(['name'], allowMultipleNulls: false));
