...
trait DoublePrecisionTestTrait
{
     ...
     */
    public static function doublePrecisionLowerValidationBoundProvider(): array
    {
        return [
            'inclusive' => [
                'greaterThanOrEquals',
     ...
     * @return array<string, array{string, string}>
     */
    public static function doublePrecisionUpperValidationBoundProvider(): array
    {
        return [
            'inclusive' => [
                'lessThanOrEquals',
    ...
    #[DataProvider('doublePrecisionLowerValidationBoundProvider')]
    public function testDoublePrecisionLowerValidationBound(string $rule, string $expected): void
    {
        $this->db->query(<<<'SQL'
            CREATE TABLE contexts (
                id INTEGER GENERATED BY DEFAULT AS IDENTITY,
    ...
    #[DataProvider('doublePrecisionUpperValidationBoundProvider')]
    public function testDoublePrecisionUpperValidationBound(string $rule, string $expected): void
    {
        $this->db->query(<<<'SQL'
            CREATE TABLE contexts (
                id INTEGER GENERATED BY DEFAULT AS IDENTITY,
