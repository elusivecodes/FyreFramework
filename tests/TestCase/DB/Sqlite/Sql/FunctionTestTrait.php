...
trait FunctionTestTrait
{
    ...
    {
        $this->assertSame(
            'SELECT "test"."first" || \' \' || "test"."last" AS "value" FROM "test"',
            $this->db->select([
                'value' => static fn(Query $query): FunctionExpression => $query->func()
                    ->concat([
    ...
    {
        $this->assertSame(
            'SELECT DATETIME("test"."created", (1 * 7) || \' day\') AS "date" FROM "test"',
            $this->db->select([
    ...
    {
        $this->assertSame(
            'SELECT (JULIANDAY("test"."created") - JULIANDAY("test"."updated")) AS "value" FROM "test"',
            $this->db->select([
                'value' => static fn(Query $query): FunctionExpression => $query->func()
                    ->dateDiff([
    ...
    {
        $this->assertSame(
            'SELECT CAST(STRFTIME(\'%Y\', "test"."created") AS INTEGER) AS "value" FROM "test"',
            $this->db->select([
                'value' => static fn(Query $query): FunctionExpression => $query->func()
    ...
    {
        $this->assertSame(
            'SELECT (CAST(STRFTIME(\'%w\', "test"."created") AS INTEGER) + 1) AS "value" FROM "test"',
            $this->db->select([
                'value' => static fn(Query $query): FunctionExpression => $query->func()
    ...
    {
        $this->assertSame(
            'SELECT CAST(STRFTIME(\'%m\', "test"."created") AS INTEGER) AS "value" FROM "test"',
            $this->db->select([
                'value' => static fn(Query $query): FunctionExpression => $query->func()
    ...
    {
        $this->assertSame(
            'SELECT JSON_EXTRACT("test"."data", \'$.name\') AS "value" FROM "test"',
            $this->db->select([
                'value' => static fn(Query $query): FunctionExpression => $query->func()
    ...
    {
        $this->assertSame(
            'SELECT ((CAST(STRFTIME(\'%w\', "test"."created") AS INTEGER) + 6) % 7) AS "value" FROM "test"',
            $this->db->select([
                'value' => static fn(Query $query): FunctionExpression => $query->func()
