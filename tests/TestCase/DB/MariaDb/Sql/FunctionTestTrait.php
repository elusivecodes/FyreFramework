...
trait FunctionTestTrait
{
    ...
    {
        $this->assertSame(
            'SELECT DATE_ADD(`test`.`created`, INTERVAL 1 WEEK) AS `date` FROM `test`',
            $this->db->select([
    ...
    {
        $this->assertSame(
            'SELECT DATEDIFF(`test`.`created`, `test`.`updated`) AS `value` FROM `test`',
            $this->db->select([
                'value' => static fn(Query $query): FunctionExpression => $query->func()
                    ->dateDiff([
    ...
    {
        $this->assertSame(
            'SELECT EXTRACT(YEAR FROM `test`.`created`) AS `value` FROM `test`',
            $this->db->select([
                'value' => static fn(Query $query): FunctionExpression => $query->func()
    ...
    {
        $this->assertSame(
            'SELECT DATE_SUB(`test`.`created`, INTERVAL 1 WEEK) AS `date` FROM `test`',
            $this->db->select([
                'date' => static fn(Query $query): FunctionExpression => $query->func()
    ...
    {
        $this->assertSame(
            'SELECT DAYOFWEEK(`test`.`created`) AS `value` FROM `test`',
            $this->db->select([
                'value' => static fn(Query $query): FunctionExpression => $query->func()
    ...
    {
        $this->assertSame(
            'SELECT JSON_VALUE(`test`.`data`, \'$.name\') AS `value` FROM `test`',
            $this->db->select([
                'value' => static fn(Query $query): FunctionExpression => $query->func()
    ...
    {
        $this->assertSame(
            'SELECT WEEKDAY(`test`.`created`) AS `value` FROM `test`',
            $this->db->select([
                'value' => static fn(Query $query): FunctionExpression => $query->func()
