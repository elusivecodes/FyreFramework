...
use Tests\TestCase\DB\Forge\Mysql\QueryGeneratorTestTrait;
...
final class QueryGeneratorTest extends TestCase
{
    ...
    public function testBuildJsonColumn(): void
    {
        $column = $this->table
            ->addColumn('value', [
                'type' => JsonType::class,
    ...
    protected function setUp(): void
    {
        ...
        $db = $container->build(TestMariaDbConnection::class);

        $container->use(SchemaRegistry::class)
            ->map(TestMariaDbConnection::class, TestSchema::class);
