...
trait InsertTestTrait
{
    ...
    {
        $this->assertSame(
            'INSERT INTO test (name, value) VALUES (\'Test 1\', 1), (\'Test 2\', 2) RETURNING *',
            $this->db->insert()
                ->into('test')
                ->values([
                    [
    ...
    {
        $this->assertSame(
            'INSERT INTO test (name, value) VALUES (\'Test 1\', (SELECT id FROM test LIMIT 1)), (\'Test 2\', (SELECT id FROM test LIMIT 1)) RETURNING *',
            $this->db->insert()
                ->into('test')
                ->values([
                    [
    ...
    {
        $this->assertSame(
            'INSERT INTO test (name, value) VALUES (\'Test 1\', \'2020-01-01 00:00:00\') RETURNING *',
            $this->db->insert()
                ->into('test')
                ->values([
                    [
    ...
    {
        $this->assertSame(
            'INSERT INTO test (name, value) VALUES (\'Test 1\', 2 * 10), (\'Test 2\', 2 * 20) RETURNING *',
            $this->db->insert()
                ->into('test')
                ->values([
                    [
    ...
    {
        $this->assertSame(
            'INSERT INTO test (name, value) VALUES (\'Test 2\', 2) RETURNING *',
            $this->db->insert()
                ->into('test')
                ->values([
                    [
