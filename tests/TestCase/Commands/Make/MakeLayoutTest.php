...
final class MakeLayoutTest extends TestCase
{
    ...
    public function testMakeLayout(): void
    {
        ...
        rewind($this->output);
        $this->assertSame(
            "\033[0;32mGenerated: tmp/templates/layouts/default.php\033[0m".PHP_EOL,
    ...
    public function testMakeLayoutExistingFile(): void
    {
        ...
        rewind($this->error);
        $this->assertSame(
            "\033[0;31mLayout file already exists.\033[0m".PHP_EOL,
    ...
    public function testMakeLayoutInvalidPath(): void
    {
        ...
        rewind($this->error);
        $this->assertSame(
            "\033[0;31mInvalid layout path.\033[0m".PHP_EOL,
            stream_get_contents($this->error)
        );
    }
