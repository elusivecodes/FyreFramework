...
final class SrgbLinearTest extends TestCase
{
    ...
    public function testGetBlue(): void
    {
        ...
        $this->assertSame(0.9559733532492861, $color->getBlue());
    }
    ...
    public function testGetGreen(): void
    {
        ...
        $this->assertSame(0.7912979403326302, $color->getGreen());
    }
    ...
    public function testGetRed(): void
    {
        ...
        $this->assertSame(0.7912979403326302, $color->getRed());
    }
