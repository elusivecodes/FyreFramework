...
trait MaxTestTrait
{
     ...
     */
    public static function maxPathProvider(): array
    {
        $items = [
            ['id' => 1, 'value' => 2],
            ['id' => 2, 'value' => 4],
     ...
     */
    #[DataProvider('maxPathProvider')]
    public function testMaxPath(array $values, Closure|string $valuePath): void
    {
        $collection = new Collection($values);

        $this->assertSame(
            5,
            $collection->max($valuePath)
        );
    }
}
