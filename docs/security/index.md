...
Security covers CORS, CSRF protection, Content Security Policy, encryption, and rate limiting.
...
| Risk | Control |
| --- | --- |
| unintended cross-origin access by browser scripts | [Cross-Origin Resource Sharing (CORS)](cors.md) |
...
CORS, CSRF, CSP, and rate limiting protect different parts of the HTTP boundary and may be combined. Encryption protects values at storage or transport boundaries; it does not replace access control, secure transport, or password hashing.

## Pages in this section

- [Cross-Origin Resource Sharing (CORS)](cors.md) - control which browser origins can read selected responses
